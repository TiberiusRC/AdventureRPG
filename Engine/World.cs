...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_TOWN_SQUARE, "Town square", "You see a fountain and next to it , A sleazy looking merchant.");
            Vendor bobTheRatCatcher = new Vendor("Detlev the Rat-Sniffer");
